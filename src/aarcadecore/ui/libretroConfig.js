...
function initLibretroConfig() {
    ...
    function onCoresTab(content) {
        content.innerHTML = '<p style="color:#888; padding:16px;">Cores configuration placeholder.</p>';
    }

    function onAboutTab(content) {
        content.innerHTML = '<p style="color:#888; padding:16px;">About Libretro integration.</p>';
    }
