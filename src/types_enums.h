...
enum INPUT_FUNC
{
    ...
    /* AArcade keybinds */
    INPUT_FUNC_AATASKSTAB = 75,
    INPUT_FUNC_AALIBRARYTAB = 76,
    INPUT_FUNC_AATABMENU = 77,
    INPUT_FUNC_AASELECT = 78,
    INPUT_FUNC_AABUILD = 79,
    INPUT_FUNC_AAREMEMBER = 80,
    INPUT_FUNC_AAVIRTUALINPUT = 81,
    INPUT_FUNC_AAINPUTLOCK = 82,
    INPUT_FUNC_MAX = 83,
